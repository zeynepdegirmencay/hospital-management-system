...
def main():
    try:
        ...
        data = {
            ...
            "Soyad": [
                personel1.get_soyad(), personel2.get_soyad(), doktor1.get_soyad(), doktor2.get_soyad(),
                doktor3.get_soyad(),
                hemsire1.get_soyad(), hemsire2.get_soyad(), hemsire3.get_soyad(), hasta1.get_soyad(),
                hasta2.get_soyad(), hasta3.get_soyad()
            ],
            "Departman": [
                personel1.get_departman(), personel2.get_departman(), doktor1.get_departman(), doktor2.get_departman(),
                doktor3.get_departman(),
            ...
            "Uzmanlık": [
                None, None, doktor1.get_uzmanlik(), doktor2.get_uzmanlik(), doktor3.get_uzmanlik(), None, None, None,
                None, None, None
            ],
            "Deneyim Yılı": [
                None, None, doktor1.get_deneyim_yili(), doktor2.get_deneyim_yili(), doktor3.get_deneyim_yili(), None,
            ...
            "Çalışma Saati": [
                None, None, None, None, None, hemsire1.get_calisma_saati(), hemsire2.get_calisma_saati(),
                hemsire3.get_calisma_saati(), None, None, None
            ],
            "Sertifika": [
                None, None, None, None, None, hemsire1.get_sertifika(), hemsire2.get_sertifika(),
                hemsire3.get_sertifika(), None, None, None
            ],
            "Hasta No": [
                None, None, None, None, None, None, None, None, hasta1.get_hasta_no(), hasta2.get_hasta_no(),
                hasta3.get_hasta_no()
            ],
            "Doğum Tarihi": [
                None, None, None, None, None, None, None, None, hasta1.get_dogum_tarihi(), hasta2.get_dogum_tarihi(),
                hasta3.get_dogum_tarihi()
            ],
            "Hastalık": [
                None, None, None, None, None, None, None, None, hasta1.get_hastalik(), hasta2.get_hastalik(),
                hasta3.get_hastalik()
            ],
            "Tedavi": [
                None, None, None, None, None, None, None, None, hasta1.get_tedavi(), hasta2.get_tedavi(),
                hasta3.get_tedavi()
            ]
        }
        ...
        uzmanlik_grup = df[df["Uzmanlık"] != 0].groupby(
            "Uzmanlık").size()  # Doktorları uzmanlıklarına göre gruplandırıp sayılarını buluyoruz.
        print("\nUzmanlıklarına Göre Doktor Sayıları:\n", uzmanlik_grup)

        deneyimli_doktorlar = df[(df["Deneyim Yılı"] > 5)].shape[
            0]  # 5 yıldan fazla deneyimli doktorların sayısını bulmak
        ...
        yeni_df = df[["Ad", "Soyad", "Departman", "Maas", "Uzmanlık", "Deneyim Yılı", "Hastalık",
                      "Tedavi"]]  # Bulduklarımızı yeni DataFrame'e dönüştürüyoruz.
